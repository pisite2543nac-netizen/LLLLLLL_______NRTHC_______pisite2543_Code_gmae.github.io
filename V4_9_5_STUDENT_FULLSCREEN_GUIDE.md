# V4.12.0 — Student Fullscreen Session + Daily Quest Auto Start
...
ดังนั้น V4.12.0 ขอ Fullscreen จากการกด Login/Register ทันที ก่อน Firebase Auth ทำงาน
...
Firestore Rules:
V4.12.0 ใช้ rules เดิมจาก V4.9.4/V4.9.3 สำหรับ daily_checkins / usage / GM
