# FULL CODE V4.8.3 NR-GAME REAL ART 2D ZONE
...
<head>
  ...
  <link rel="stylesheet" href="./style.css?v=4.8.3">
</head>
<body>
...
<script type="module" src="./app.js?v=4.8.3"></script>
...
<body class="admin-page">
  <main class="wrap admin-wrap">
    ...
    <section id="adminDashboard" class="hidden">
      <div class="admin-titlebar">
        ...
        <div>
          <a class="btn gm-zone-entry" href="./zone.html?v=4.8.3">🌙 เข้า 2D Zone · GM</a>
      ...
      <section id="zoneChatLogTab" class="admin-tab-panel hidden">
        ...
        <div class="admin-world-chat-composer">
          ...
          <div class="admin-world-chat-input-row">
            ...
            <a class="btn gm-zone-entry" href="./zone.html?v=4.8.3#world-chat">เข้า World Chat</a>
          </div>
        </div>
  ...
  <script type="module" src="./admin.js?v=4.8.3"></script>
</body>
</html>
...
<body class="zone47-page">
  <div id="zoneGate" class="zone47-gate">
    <div class="zone47-gate-card">
      ...
      <span class="section-kicker">2D SOCIAL ZONE · V4.8.3 · REAL ART</span>
  ...
  <script type="module" src="./zone.js?v=4.8.3"></script>
</body>
</html>
...
```html
<!DOCTYPE html><html lang="th"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="refresh" content="0;url=./zone.html?v=4.8.3"><title>ย้ายไป 2D Zone</title><script>location.replace("./zone.html?v=4.8.3");</script></head><body><p>ระบบแชตรวมย้ายเข้า 2D Zone แล้ว</p><a href="./zone.html?v=4.8.3">เข้า 2D Zone</a></body></html>
```
...
/* =====================================================================
   V4.8.3 — DUAL RANKING / PVP MULTI ROOM / TOKEN ECONOMY / ITEM SET 2
   ===================================================================== */
...
/* ==================================================================
   V4.8.3 ADMIN CLASSROOM / RANK RESET / GM WORLD CHAT / PVP COUNTDOWN
   ================================================================== */
...
/* ===== V4.8.3 SIMPLE CHAT-ONLY 2D ZONE ===== */
...
/* ==================================================================
   V4.8.3 HORIZONTAL SMOOTH ZONE + WIZARD + TOKEN SHOP
   ================================================================== */
...
/* ===== V4.8.3 PLAY STYLE + RANKED CHALLENGE ===== */
...
/* V4.8.3 Student ID 1-15 digits */
#studentId15Hint{color:#607888}


/* ===== V4.8.3 REAL ART 2D ZONE ===== */
...
import { firebaseConfig } from "./firebase-config.js?v=4.8.3";
import { LANGUAGES, LESSONS, DIFFICULTIES } from "./lessons.js?v=4.8.3";
import { REWARD_ITEMS, RARITY_META } from "./reward-data.js?v=4.8.3";
import { DEFAULT_CHARACTER, DEFAULT_ZONE_STATE } from "./character-system.js?v=4.8.3";
import { OFFICIAL_STAGES, OFFICIAL_TOTAL_SCORE } from "./official-data.js?v=4.8.3";
import { RANKING_CONFIG, seasonIdFromDate, seasonRange, calculateRankMetrics, rankingClassKey, rankProfiles } from "./ranking-system.js?v=4.8.3";
import { TOKEN_REWARD_CONFIG, calculateStageTokenReward, maxTokenForLesson, classKey } from "./economy-system.js?v=4.8.3";
import { DEFAULT_TEACHER_QUESTS, localDayKey, questObjectiveMet, questObjectiveLabel, clampQuestReward } from "./quest-system.js?v=4.8.3";
...
async function routeAuthenticatedStudent(){
  ...
  if(isMobileOrTabletDevice() && ["male","female"].includes(state.player?.character?.gender)){
    ...
    location.replace("./zone.html?v=4.8.3");
    return;
  }
...
$("questZoneButton").onclick=()=>{location.href="./zone.html?v=4.8.3"};
...
/* ===== V4.8.3 PVP MULTI ROOM · 1/3/5 SHOT · 1V1/2V2 RELAY · TOKEN WAGER ===== */
...
onAuthStateChanged(auth,async user=>{
  ...
  if(user.email==="pisit_2000@nr-game-code.local"){location.replace("./admin.html?v=4.8.3");return;}
  state.uid=user.uid;
  try{
    await routeAuthenticatedStudent();
  }catch(error){
...
```js
import { HTML_LEVELS } from "./levels-html.js?v=4.8.3";
import { PYTHON_LEVELS } from "./levels-python.js?v=4.8.3";
