# FULL CODE V4.7.7 NR-GAME MAJOR ROOM RANKING
...
<head>
  ...
  <link rel="stylesheet" href="./style.css?v=4.7.7">
</head>
<body>
...
<script type="module" src="./app.js?v=4.7.7"></script>
...
<body class="admin-page">
  <main class="wrap admin-wrap">
    ...
    <section id="adminDashboard" class="hidden">
      <div class="admin-titlebar">
        ...
        <div>
          <a class="btn gm-zone-entry" href="./zone.html?v=4.7.7">🌙 เข้า 2D Zone · GM</a>
      ...
      <section id="zoneChatLogTab" class="admin-tab-panel hidden">
        ...
        <div class="admin-world-chat-composer">
          ...
          <div class="admin-world-chat-input-row">
            ...
            <a class="btn gm-zone-entry" href="./zone.html?v=4.7.7#world-chat">เข้า World Chat</a>
          </div>
        </div>
  ...
  <script type="module" src="./admin.js?v=4.7.7"></script>
</body>
</html>
...
<body class="zone47-page">
  <div id="zoneGate" class="zone47-gate">
    <div class="zone47-gate-card">
      ...
      <span class="section-kicker">2D SOCIAL ZONE · V4.7.7.0</span>
  ...
  <script type="module" src="./zone.js?v=4.7.7"></script>
</body>
</html>
...
```html
<!DOCTYPE html><html lang="th"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="refresh" content="0;url=./zone.html?v=4.7.7"><title>ย้ายไป 2D Zone</title><script>location.replace("./zone.html?v=4.7.7");</script></head><body><p>ระบบแชตรวมย้ายเข้า 2D Zone แล้ว</p><a href="./zone.html?v=4.7.7">เข้า 2D Zone</a></body></html>
```
...
/* =====================================================================
   V4.7.7 — DUAL RANKING / PVP MULTI ROOM / TOKEN ECONOMY / ITEM SET 2
   ===================================================================== */
...
/* ==================================================================
   V4.7.7 ADMIN CLASSROOM / RANK RESET / GM WORLD CHAT / PVP COUNTDOWN
   ================================================================== */
...
/* ===== V4.7.7 SIMPLE CHAT-ONLY 2D ZONE ===== */
...
/* ==================================================================
   V4.7.7 HORIZONTAL SMOOTH ZONE + WIZARD + TOKEN SHOP
   ================================================================== */
...
/* ===== V4.7.7 PLAY STYLE + RANKED CHALLENGE ===== */
...
import { firebaseConfig, ADMIN_USERNAME, ADMIN_EMAIL, ADMIN_UID } from "./firebase-config.js?v=4.7.7";
import { DEFAULT_MODES, DEFAULT_LEVELS } from "./default-data.js?v=4.7.7";
import { seasonIdFromDate, seasonRange, calculateRankMetrics, rankingClassKey } from "./ranking-system.js?v=4.7.7";
import { DEFAULT_TEACHER_QUESTS, clampQuestReward, questDifficultyName, questObjectiveLabel, defaultMinRankForDifficulty, rewardRange } from "./quest-system.js?v=4.7.7";
...
import { firebaseConfig, ADMIN_UID } from "./firebase-config.js?v=4.7.7";
import { REWARD_ITEMS, RARITY_META } from "./reward-data.js?v=4.7.7";
import { DEFAULT_CHARACTER } from "./character-system.js?v=4.7.7";
import {
...
async function checkModeration(){
  ...
  try{
    ...
    return true;
  }catch(error){showGate("ตรวจสอบสิทธิ์ Zone ไม่สำเร็จ",error.message||String(error),"กรุณา Publish firestore.rules V4.7.7");return false}
}
...
function startQuest(id){
  ...
  location.href=`./index.html?quest=${encodeURIComponent(id)}&v=4.7.7`;
}
...
```js
import { HTML_LEVELS } from "./levels-html.js?v=4.7.7";
import { PYTHON_LEVELS } from "./levels-python.js?v=4.7.7";
